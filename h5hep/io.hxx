...
static inline size_t SimpleReadExtents(const std::vector<Span> &extents, void *buf, hid_t datasetId, hid_t spaceId,
                                       hid_t typeId) {
...
static inline size_t SimpleWriteExtents(const std::vector<Span> &extents, const void *buf, hid_t datasetId,
                                        hid_t &spaceId, hid_t typeId) {
...
static inline void CopyElements(void *__restrict dest, const void *__restrict src, size_t n, size_t sz,
                                size_t stride_dest, size_t stride_src) {
...
class ReaderWriter {
  ...
  public:
    ...
    virtual size_t ReadExtents(const std::vector<Span> &extents, void *buf) { return root->ReadExtents(extents, buf); }
    ...
    size_t WriteChunk(size_t n, void *buf) { return WriteChunk(n, buf, props.GetChunkSize()); }
};
...
template <typename T> class BufferedWriter {
